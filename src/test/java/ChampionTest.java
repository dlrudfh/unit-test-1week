...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1, endsWith(endString));
        assertThat(sampleString2, startsWith(startString));
        assertThat(sampleString2, containsString("point"));

        //anyOf는 하나만 맞아도 됨, allOf는 다맞아야됨
        assertThat(sampleString1, anyOf(startsWith("Player"), endsWith("asfdsaf")));
        assertThat(sampleString2, allOf(containsString((startString)), endsWith(endString)));
    ...
    public void testForFloatingPoint() {
        double test = 3.148789;
        //3을 기준으로 0.2의 오차범위 내인지
        assertThat(test, closeTo(3, 0.2));
    }
    ...
    public void shouldHaveSamePropertyAndValue() {
        ...
        List<String> championNames3 = championNames1;

        assertThat(championNames1, samePropertyValuesAs(championNames3));
        assertThat(championNames3, samePropertyValuesAs(championNames2));
    }
